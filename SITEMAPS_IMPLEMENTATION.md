...
1. **Sitemap Index (Primary)**
   - `https://australia.anksquare.com/sitemap.xml` - Returns XML sitemap index
   - `https://australia.anksquare.com/sitemap-index` - Alternative sitemap index endpoint

2. **Individual Sitemaps**
   - `https://australia.anksquare.com/sitemap-1.xml` - First chunk of URLs (up to 50,000)
   - `https://australia.anksquare.com/sitemap-2.xml` - Second chunk of URLs (up to 50,000)
   - `https://australia.anksquare.com/sitemap-N.xml` - Nth chunk of URLs (dynamically generated)
...
5. Submit new sitemaps:
   - `https://australia.anksquare.com/sitemap.xml` (sitemap index)
   - OR submit individual sitemaps: `https://australia.anksquare.com/sitemap-1.xml`, etc.

**Bing Webmaster Tools:**
1. Go to https://www.bing.com/webmaster
2. Select your site
3. Go to Sitemaps section
4. Add sitemap: `https://australia.anksquare.com/sitemap.xml`

### 3. Verify Robots.txt
The robots.txt has been updated with:
```
Sitemap: https://australia.anksquare.com/sitemap-index
```
...
```bash
# Test sitemap index
curl -I https://australia.anksquare.com/sitemap.xml

# Test first sitemap
curl -I https://australia.anksquare.com/sitemap-1.xml

# Test second sitemap
curl -I https://australia.anksquare.com/sitemap-2.xml
