...
- `https://australia.anksquare.com/sitemap.xml` - Sitemap Index (Primary)
- `https://australia.anksquare.com/sitemap/1.xml` - Sitemap 1 (URLs 1-50,000)
- `https://australia.anksquare.com/sitemap/2.xml` - Sitemap 2 (URLs 50,001-54,538)
- `https://australia.anksquare.com/sitemap-index` - Alternative index
...
1. **Google Search Console**
   ...
   - Submit: `https://australia.anksquare.com/sitemap.xml`
...
```bash
# Test sitemap index
curl https://australia.anksquare.com/sitemap.xml

# Test individual sitemaps
curl https://australia.anksquare.com/sitemap-1.xml
curl https://australia.anksquare.com/sitemap-2.xml
